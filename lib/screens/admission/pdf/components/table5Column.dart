...
class Table5columnPdf extends pw.StatelessWidget{
  final text1,text2,text3,text4;
   PdfColor color1,color2,color3,color4,color5,text1Color,text2Color,text3Color,text4Color,text5Color;
   double flex1,flex2,flex3,flex4,flex5;
   bool isText1,isText2,isText3,isText4,isText5;
  pw.TextAlign textAlign1,textAlign2,textAlign3,textAlign4,textAlign5;
